            ...
            <div className=''>
                <div className=' text-center'>
                    ...
                    <form onSubmit={addTutorial}>
                        <label className='my-3'>
                            <input name='title' type="text" className='w-full bg-gray-800 text-center py-1 rounded' placeholder='Add Title' required />
                        </label>
                        <div>
                            <select name='category' className='w-full bg-gray-800 text-center py-1 rounded  my-3' required>
                ...
                <div className='my-10'>
                    ...
                    <form onSubmit={addCategory}>
                        <label>
                            <input name='category' type="text" className='bg-gray-800 text-center py-1 rounded  w-full' placeholder='Category Name' required />
                        </label>
