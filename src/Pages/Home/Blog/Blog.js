...
const Blog = () => {
    ...
    const blogData = [
        {
            id:1,
            name: '',
            title: 'Make-Ahead Breakfasts Under 300 Calories',
            image: 'https://images.unsplash.com/photo-1657310216850-8f2bf9b7de1b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
            ...
            detailPageImage:'https://blog.myfitnesspal.com/wp-content/uploads/2020/02/The-Problem-with-Cheat-Days-2-752x472.jpg',
            elements: [
                {
                    id:1,
                    firstName:' MAKE-AHEAD INSTANT OATMEAL JARS',
                    lasttName: 'FITLESSIAN’S ORIGINAL RECIPES',
                    image: 'https://blog.myfitnesspal.com/wp-content/uploads/2020/02/15-Make-Ahead-Breakfasts-Under-300-Calories-1.jpg',
                    details : 'Calories: 229; Total Fat: 6g; Saturated Fat: 1g; Monounsaturated Fat: 2g; Cholesterol: 0mg; Sodium: 152mg; Carbohydrate: 38g; Dietary Fiber: 5g; Sugar: 7g; Protein: 6g' 
                },
                {
                    id:2,
                    firstName:'CAULIFLOWER-CRUSTED SPINACH FETA PIE',
                    lasttName: 'FITLESSIAN’S RECIPES',
                    image: 'https://blog.myfitnesspal.com/wp-content/uploads/2020/02/15-Make-Ahead-Breakfasts-Under-300-Calories-2.jpg',
                    details : 'Calories: 136; Total Fat: 6g; Saturated Fat: 3g; Monounsaturated Fat: 1g; Cholesterol: 68mg; Sodium: 330mg; Carbohydrate: 11g; Dietary Fiber: 5g; Sugar: 4g; Protein: 13g' 
                },
                {
                    id:3,
                    firstName:'1-MINUTE BERRY PEANUT BUTTER SMOOTHIE FOR TWO',
                    lasttName: 'FITLESSIAN’S RECIPES',
                    image: 'https://blog.myfitnesspal.com/wp-content/uploads/2020/02/15-Make-Ahead-Breakfasts-Under-300-Calories-3.jpg',
                    details : 'Calories: 156; Total Fat: 8g; Saturated Fat: 1g; Monounsaturated Fat: 0g; Cholesterol: 1mg; Sodium: 57mg; Carbohydrate: 19g; Dietary Fiber: 7g; Sugar: 9g; Protein: 5g' 
                },
                {
                    id:4,
                    firstName:' PEANUT BUTTER BREAKFAST COOKIES',
                    lasttName: 'FITLESSIAN’S RECIPES',
                    image: 'https://blog.myfitnesspal.com/wp-content/uploads/2020/02/15-Make-Ahead-Breakfasts-Under-300-Calories-4.jpg',
                    details : 'Calories: 299; Total Fat: 15g; Saturated Fat: 3g; Monounsaturated Fat: 0g; Cholesterol: 53mg; Sodium: 131mg; Carbohydrate: 34g; Dietary Fiber: 6g; Sugar: 13g; Protein: 11g' 
                },
                {
                    id:5,
                    ...
                    lasttName: 'FITLESSIAN’S RECIPES',
                    image: 'https://blog.myfitnesspal.com/wp-content/uploads/2020/02/15-Make-Ahead-Breakfasts-Under-300-Calories-4.jpg',
                    details : 'Calories: 186; Total Fat: 2g; Saturated Fat: 0g; Monounsaturated Fat: 1g; Cholesterol: 3mg; Sodium: 75mg; Carbohydrate: 35g; Dietary Fiber: 5g; Sugar: 18g; Protein: 8g' 
                },
            ]
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1514995669114-6081e934b693?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
            details: 'Instead of cheat meals or a cheat day, try these three strategies, which can help foster a positive relationship with food:',
            detailPageImage:'https://blog.myfitnesspal.com/wp-content/uploads/2020/02/The-Problem-with-Cheat-Days-2-752x472.jpg',
            elements: [
                {
                    id:1,
                ...
                },
                {
                    ...
                    lasttName: '',
                    // image: '',
                    details : 'Nourishment is one of my favorite words to use with clients because it encompasses how we take care of ourselves both physically and emotionally. When it comes to food, this means that sometimes, the most nourishing choice we can make is to add another serving of vegetables to our plate. Other times, we just really need a cookie. Both are OK and nourishing to the body, soul or both when we need them. What is going to be nourishing to you one day may be different the next, so being mindful and open to what you need to best take care of yourself is an invaluable tool.' 
                }
             ]
        },
        {
            ...
            elements: [
                ...
                },
                {
                    ...
                    lasttName: '',
                    // image: '',
                    details: 'If you’re new to working out, walking is a great place to start. And yes, walking is sufficient exercise to lose weight and get in shape.' 
                },
                {
                    id:3,
    ...
    return (
        <div className='pb-30'>
           ...
           <h1 className='text-4xl text-white font-bold text-center'>Recipes & Inspiration</h1>
            <p className='text-center  w-2/3'>Get nutritionist-approved recipes and motivational workout tips from Fitlessian experts.</p>
           </div>
            
          <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-10'>
          {blogData.map(blog=><div key={blog.id} blog={blog} className="card card-compact w-96 bg-base-100 shadow-xl">
                <figure><img src={blog.image} alt="img" /></figure>
                <div className="card-body relative">
                    <h2 className="card-title">{blog.title}</h2>
                    {/* <p>{blog.title}</p> */}
                    <Link to={`/blog/${blog.id}`}  state={{ from: { blog } }}>
                    <div class="absolute bottom-2 left-4">
                        <button className="text-green-500">Fitlessian Blog</button>
                    </div>
                    </Link>
                </div>
            </div>)}
