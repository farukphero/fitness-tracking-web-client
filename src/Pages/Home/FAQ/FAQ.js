...
const Faqs = () => {
  ...
  return (
    <div  className="w-full my-10 shadow-xl image-full"
    data-aos="fade-up"
     ...
     >
      ...
      <div className="hero">
        <div className="hero-content flex-col lg:flex-row">
          <img
            className="w-1/2"
            src="https://i.ibb.co/4P7LxmP/0-Fd-LLSj-LPud-Gd-Pt5-removebg-preview.png"
            alt=""
          />
          <div>
                    ...
                    <div className="flex justify-center">
                      <div className="relative p-3  text-black ">
                        ...
                        <div className="mb-3 mt-3">
                          <label
                            className="mt-3 text-2xl px-8 font-semibold text-blue-700 ml-2 tracking-[1px] mx-[20px] h-[50px] flex items-center"
                            for="input"
                          >
                            {faq.quetions}
                          </label>
      ...
      <label htmlFor="my-modal-6" className="btn bg-secondary hover:bg-secondary text-black mb-20">
        Ask Your Questions
      </label>
      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          <div className="card-body">
            ...
            <p className="text-4xl mb-5 text-white font-bold">
              Ask You Quetions
            </p>
            <form onSubmit={handleSubmit(handlask)}>
              ...
              <div className="form-control mb-3">
                <button className="btn bg-secondary hover:bg-secondary text-black border-none w-full ">
                  Submit
                </button>
              </div>
            </form>
